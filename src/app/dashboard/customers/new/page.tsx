  ...
  return (
    <section className="flex items-center justify-center pt-10">
      <form className="ml-[70px]  rounded-lg border-[1px] bg-white py-10 pl-[30px] shadow-sm md:w-[1000px]">
        <h3 className="text-center text-2xl font-medium">New Customer</h3>
        ...
        <section className="mt-10 grid grid-cols-2 gap-y-5">
          ...
          <ItemLayout>
            <AssetLabel label="Email (optional)" />
            <div>
              <Input className="h-[45px] bg-[#F0F0F9] md:w-[450px] " />
            </div>
          </ItemLayout>
          ...
          <ItemLayout>
            <AssetLabel label="Region" />
            <div>
              <Input className="h-[45px] bg-[#F0F0F9] md:w-[450px]" />
            </div>
          </ItemLayout>
          <ItemLayout>
            <AssetLabel label="TIN Number" />
            <div>
              <Input className="h-[45px] bg-[#F0F0F9] md:w-[450px] " />
            </div>
          </ItemLayout>
          ...
          <div className="col-span-2 ">
            <ItemLayout>
              <AssetLabel label="Identification Number (optional)" />
              <div>
