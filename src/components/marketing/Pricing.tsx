...
const tiers = [
  {
    ...
    features: [
      `Unsubscribe from 200emails per month`,
      "Email analytics",
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-2xl text-center lg:max-w-4xl">
        <h2 className="font-cal bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-base leading-7 text-transparent">
          Pricing
        </h2>
        <p className="font-cal mt-2 text-4xl text-foreground sm:text-5xl">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 px-6 py-8 shadow-xl">
          <div className="flex w-full flex-col lg:flex-row">
            <div className="p-8 sm:p-10 lg:flex-auto">
              <h3 className="font-cal flex items-center text-2xl text-white">
                Lifetime access
                <div className="ml-4">
              ...
              <div className="mt-10 flex items-center gap-x-4">
                <h4 className="font-cal flex-none bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-sm leading-6 text-transparent">
                  What’s included
                </h4>
  ...
  return (
    <div className="bg-background py-4 sm:py-8">
      <div className="relative mx-auto max-w-2xl rounded-3xl bg-white ring-1 ring-gray-200 lg:mx-0 lg:flex lg:max-w-none">
        ...
        <div className="p-8 sm:p-10 lg:flex-auto">
          <h3 className="font-cal flex items-center text-2xl text-gray-900">
            Lifetime access
            <div className="ml-4">
              <Tag color="green">Limited Time Offer</Tag>
            </div>
          ...
          <div className="mt-10 flex items-center gap-x-4">
            <h4 className="font-cal flex-none text-sm leading-6 text-blue-600">
              What’s included
            </h4>
