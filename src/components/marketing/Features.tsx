    ...
    <div className="bg-white py-24 sm:py-32" id="features">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="font-cal mt-2 text-3xl text-gray-900 sm:text-4xl">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center justify-center gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          ...
          >
            <div className="lg:max-w-lg">
              <h2 className="font-cal inline-block bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-base leading-7 text-transparent">
                {props.title}
              </h2>
              <p className="font-cal mt-2 text-3xl text-foreground sm:text-4xl">
                {props.subtitle}
              </p>
